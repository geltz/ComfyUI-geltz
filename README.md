...
## Sampling & Guidance
- **Perturbed Attention Delta** – Adds a second forward pass during generation via injected noise and reverses the path with a delta (based on [PAG](https://arxiv.org/abs/2403.17377))
