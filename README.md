...
- **Semantic Noise Sampler** – This node creates better starting noise by analyzing what the model wants to generate. It requires a full pass before denoising, so twice the steps. Based on [this paper](https://arxiv.org/abs/2511.07756)   
