...
## Sampling & Guidance
- **Perturbed Attention Delta** – Adds controlled variation during generation  
- **Quantile Match Scaling** – Prevents over-guidance with strong prompts  
- **SADA Acceleration** – Skips stable steps to speed up generation  
- **Token Shuffler** – Shuffles tokens during generation for variation  
